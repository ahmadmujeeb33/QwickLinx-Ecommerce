    ...
    return (
        <div class="flex flex-wrap  gap-5 justify-center">
            {product.data  && 
                 ...
                 <a href="#">
                     <img class="p-8 rounded-t-lg" src={product.data.image} alt="product image" />
                 </a>
                 <div class="px-5 pb-5">
                     <a href="#">
                         <h5 class="text-xl font-semibold tracking-tight text-gray-900 dark:text-white">{product.data.description}</h5>
                     </a>
